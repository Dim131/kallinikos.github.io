---
title: "29ος ΠΔΠ Γ' Φάση: Ακολουθίες DNA (dnaseq)"
layout: post
tags: []
comments: true
---
...
Ο αλγόριθμος αυτός έχει πολυπλοκότητα $$Ο(Ν^3)$$ και χρειάζεται $$Ο(Ν)$$ μνήμη.
...
Ας υποθέσουμε ότι οι $$a$$ και $$b$$ είναι οι ακολουθίες με το ελάχιστο συνολικό μήκος ώστε $$Μ_1' = aM_1b$$ και $$Μ_2' = aM_2b$$, με $$M_1' = \overline{M_2'}$$. Τότε $$aM_1b = \overline{b}\overline{M_2}\overline{a}$$ και συνεπώς $$a$$ και $$\overline{b}$$ έχουν κοινό prefix. Άρα υπάρχει $$k$$ ώστε $$a = ka'$$ και $$b = b'k$$. Άρα $$Μ_1' = ka'M_1b'k$$ και $$Μ_2' = ka'M_2b'k$$. Άρα τα $$M_1'' =a'M_1b'$$ και $$Μ_2'' = a'M_2b'$$, είναι αντίστροφες. Αλλά $$a''$$ και $$b''$$ έχουν μικρότερο συνολικό μήκος από το ελάχιστο. Άτοπο.
...
*Απόδειξη:* Ούτε το $$Μ$$ μπορεί να είναι μικρότερο, ούτε το $$L$$ μεγαλύτερο. Επομένως αυτή είναι η ελάχιστη διαφορά τους.
